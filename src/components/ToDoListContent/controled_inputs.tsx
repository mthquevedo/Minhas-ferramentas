...
import { taskGenre, taskGenreValues } from "../ToDoItem/constants"; // Atualizar para taskGenre e taskGenreValues

export function ToDoListContent() {
    const { tasks, addTask } = useToDo();

    // Usar taskGenreValues em vez de GenreEnum
    const [option, setOption] = useState<taskGenreValues>(taskGenre.ESTUDO);
    ...
    const clearInputs = () => {
        setOption(taskGenre.ESTUDO); // Resetar para "Estudo"
        setContent(""); // Limpar o conteúdo da tarefa
    };
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <select
                                ...
                                id="genderOptions"
                                value={option}
                                onChange={(e) => setOption(e.target.value as taskGenreValues)}
